# muad classes
# for backup, not used in the code.
...
training_classes = {
    'vehicle': ['car', 'bus', 'truck', 'van', 'cyclist', 'biker', 'motorcycle', 'bicycle', 'tricycle'],
    'drivable_area': ['road'],
    'road_lines': ['road_lines'],
    'ood': ['rock', 'garbage_bag', 'trash_can', 'Stand food', 'Moose', 'Deer', 'Bear', 'Cow'],
}